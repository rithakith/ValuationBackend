    ...
    public static class DbInitializer
    {
        ...
        private static void InitializeMasterData(AppDbContext context)
        {
            ...
            var items = new List<(string Category, string Value)>
            {
                ...
                ("conviences", "Fully Furnished"),
                ("conviences", "Semi Furnished"),
                ("conviences", "Basic Amenities"),
                ("conviences", "Luxury Amenities"),
                ("conviences", "Unfurnished"),
                ("natureOfConstruction", "Permanent Structure"),
                ("natureOfConstruction", "Semi-Permanent"),
                ("natureOfConstruction", "Temporary Structure"),
                ("natureOfConstruction", "Prefabricated"),
                ("roofMaterial", "Clay Tiles"),
                ("roofMaterial", "Asbestos Sheets"),
                ("roofMaterial", "Concrete Slab"),
                ("roofMaterial", "Metal Sheets"),
                ("roofMaterial", "Calicut Tiles"),
                ("roofFrame", "Timber Frame"),
                ("roofFrame", "Steel Frame"),
                ("roofFrame", "Concrete Frame"),
                ("roofFrame", "Aluminum Frame"),
                ("roofFinisher", "Painted"),
                ("roofFinisher", "Varnished"),
                ("roofFinisher", "Natural Finish"),
                ("roofFinisher", "Waterproofed"),
                ("celing", "Gypsum Board"),
                ("celing", "Wooden Panels"),
                ("celing", "PVC Ceiling"),
                ("celing", "Exposed Beams"),
                ("celing", "Plaster Ceiling"),
                ("foundationStructure", "Concrete Foundation"),
                ("foundationStructure", "Stone Foundation"),
                ("foundationStructure", "Pile Foundation"),
                ("foundationStructure", "Rubble Foundation"),
                ("wallStructure", "Brick Walls"),
                ("wallStructure", "Concrete Block"),
                ("wallStructure", "Clay Block"),
                ("wallStructure", "Timber Walls"),
                ("wallStructure", "Cement Board"),
                ("floorStructure", "Concrete Slab"),
                ("floorStructure", "Timber Floor"),
                ("floorStructure", "Raised Floor"),
                ("floorStructure", "Ground Level"),
                ("door", "Wooden Door"),
                ("door", "Steel Door"),
                ("door", "Glass Door"),
                ("door", "PVC Door"),
                ...
                ("window", "Bay Windows"),
                ("windowProtection", "Security Grilles"),
                ("windowProtection", "Mosquito Nets"),
                ("windowProtection", "Shutters"),
                ("windowProtection", "None"),
                ("doorsBathroomAndToiletFittings", "Standard Fittings"),
                ("doorsBathroomAndToiletFittings", "Premium Fittings"),
                ("doorsBathroomAndToiletFittings", "Designer Fittings"),
                ("doorsBathroomAndToiletFittings", "Basic Fittings"),
                ("doorsHandRail", "Stainless Steel"),
                ("doorsHandRail", "Wooden Rail"),
                ("doorsHandRail", "Glass Panel"),
                ("doorsHandRail", "Wrought Iron"),
                ("doorsPantryCupboard", "Built-in Cupboards"),
                ("doorsPantryCupboard", "Modular Kitchen"),
                ("doorsPantryCupboard", "Traditional Pantry"),
                ("doorsPantryCupboard", "Open Shelving"),
                ("doorsOther", "Garage Doors"),
                ("doorsOther", "Security Doors"),
                ("doorsOther", "Folding Doors"),
                ("doorsOther", "Automatic Doors"),
                ("wallFinisher", "Painted Walls"),
                ("wallFinisher", "Wallpaper"),
                ("wallFinisher", "Textured Paint"),
                ("wallFinisher", "Exposed Brick"),
                ("wallFinisher", "Tile Cladding"),
                ("floorFinisher", "Ceramic Tiles"),
                ("floorFinisher", "Granite"),
                ("floorFinisher", "Marble"),
                ("floorFinisher", "Wooden Flooring"),
                ("floorFinisher", "Vinyl Flooring"),
                ("floorFinisher", "Terrazzo"),
                ("bathroomAndToilet", "Attached Bathroom"),
                ("bathroomAndToilet", "Common Bathroom"),
                ("bathroomAndToilet", "En-suite"),
                ("bathroomAndToilet", "Outdoor Facilities"),
